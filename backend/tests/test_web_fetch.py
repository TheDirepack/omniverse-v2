...
async def test_fetch_page_success_no_freshness():
    ...
    with patch("app.core.web_fetch.browser_manager") as mock_bm:
        ...
        mock_page.goto.assert_called_once_with("https://example.com", wait_until="networkidle", timeout=20000)
...
async def test_fetch_page_falls_back_on_networkidle_timeout():
    with patch("app.core.web_fetch.browser_manager") as mock_bm:
        ...
        mock_page.content.return_value = "<html><body><p>Hello World</p></body></html>"
        mock_page.goto = AsyncMock(side_effect=[Exception("Timeout 20000ms exceeded"), _mock_response()])
        mock_page.url = "https://example.com"
        ...
        mock_page.goto.assert_any_call("https://example.com", wait_until="networkidle", timeout=20000)
        mock_page.goto.assert_any_call("https://example.com", wait_until="domcontentloaded", timeout=15000)
