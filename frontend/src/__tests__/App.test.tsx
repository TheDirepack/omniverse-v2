...
vi.mock("../frontend/src/components/DashboardPanel", () => ({
	default: () => <div data-testid="panel-dashboard" />,
}));
vi.mock("../frontend/src/components/DatabasePanel", () => ({
	default: () => <div data-testid="panel-database" />,
}));
vi.mock("../frontend/src/components/TheoriesPanel", () => ({
	default: () => <div data-testid="panel-theories" />,
}));
vi.mock("../frontend/src/components/settings/SettingsPanel", () => ({
...
describe("App", () => {
	...
	it("marks active nav button with active class", async () => {
		...
		expect(screen.getByText("Theories").closest("button")).toHaveClass(
			"active",
		);
	});
});
