...
def test_filter_universes_query(ephemeral_db):
    ...
    svc.create_universe(name="Marvel Cinematic Universe", franchise="Marvel")
    svc.create_universe(name="DC Extended Universe", franchise="DC")
    svc.create_universe(name="Star Wars", franchise="Lucasfilm")
...
def test_filter_universes_franchise(ephemeral_db):
    ...
    svc.create_universe(name="World 1", franchise="Marvel")
    svc.create_universe(name="World 2", franchise="DC")
