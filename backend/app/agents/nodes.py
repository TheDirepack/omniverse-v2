...
async def db_integrator_node(state: OmniverseState) -> Dict[str, Any]:
    ...
    for result in research_results:
        ...
        await run_agent(
            ...
            run_id=run_id,
            tools_names=["queryTraits", "queryUnconfirmedTraits", "upsertTrait"],
