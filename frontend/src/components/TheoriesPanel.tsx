		...
		<section className="panel-grid single">
			<div className="panel">
				...
				<p className="help-text">
					Speculative interaction projections grounded in verified research.
				</p>
				...
				>
					<div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
						<label htmlFor="scope-select" style={{ fontSize: "0.8rem", opacity: 0.8 }}>Scope</label>
						<select
							id="scope-select"
							value={scope}
							onChange={(e) => setScope(e.target.value as "all" | "worlds" | "tier")}
							style={{ padding: 4 }}
						>
					...
					{scope === "worlds" && (
						<div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
							<label htmlFor="worlds-input" style={{ fontSize: "0.8rem", opacity: 0.8 }}>
								Worlds (comma separated)
							</label>
							<input
								id="worlds-input"
								value={worldsInput}
					...
					{scope === "tier" && (
						<div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
							<label htmlFor="tier-input" style={{ fontSize: "0.8rem", opacity: 0.8 }}>
								Tier Number
							</label>
							<input
								id="tier-input"
				...
				{worldsWithTheories.length === 0 && (
					<p className="muted">
						No theories generated yet. Use the trigger above to extrapolate
						interactions.
					</p>
				)}
			</div>
