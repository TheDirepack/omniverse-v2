...
describe("TraitViewerPanel", () => {
  const mockWorlds = [
    { id: 1, name: "World A", summary: "Sum A", is_explored: true, tier: 1, tier_justification: "J1", theory: "T1", theory_audit: "A1" },
    { id: 2, name: "World B", summary: "Sum B", is_explored: true, tier: 2, tier_justification: "J2", theory: "T2", theory_audit: "A2" },
    { id: 3, name: "World C", summary: "Sum C", is_explored: true, tier: 3, tier_justification: "J3", theory: "T3", theory_audit: "A3" },
  ];

  const mockTraits = [
    { id: 101, universe_id: 1, category: "Magic", name: "System", value: "Hard Magic" },
    { id: 102, universe_id: 1, category: "Magic", name: "Power", value: "High" },
    { id: 201, universe_id: 2, category: "Tech", name: "Level", value: "Intergalactic" },
  ...
  it("renders loading state initially", () => {
    ...
    expect(screen.getByText(/Loading traits.../i)).toBeInTheDocument();
  });
  ...
  it("filters worlds when 'Only worlds with traits' is checked", async () => {
    ...
    const checkbox = screen.getByLabelText(/Only worlds with traits/i);
  ...
  it("shows empty message when no worlds match filter", async () => {
    ...
    expect(screen.getByText(/No worlds found matching the current filter/i)).toBeInTheDocument();
