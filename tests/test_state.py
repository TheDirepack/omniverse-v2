import pytest
from app.core.runtime_state import ACTIVE_RUNS, ABORTED_RUNS
...
class TestAsyncStateHelpers:
    ...
    async def test_remove_run_async(self):
        from app.core.runtime_state import add_active_run, abort_run, remove_run, get_active_runs, is_aborted
        ACTIVE_RUNS.clear()
        ABORTED_RUNS.clear()
